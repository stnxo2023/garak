...
def test_up_detector_default_strings(up_detector):
    ...
    for response in default_responses:
        attempt = Attempt(prompt="test", bcp47=up_detector.bcp47)
...
def test_up_detector_custom_strings():
    ...
    attempt = Attempt(prompt="test", bcp47=detector.bcp47)
...
def test_down_detector_default_strings(down_detector):
    ...
    for response in default_responses:
        attempt = Attempt(prompt="test", bcp47=down_detector.bcp47)
        attempt.outputs = [response]
...
def test_multiple_outputs():
    ...
    attemptd = Attempt(prompt="test", bcp47=down_detector.bcp47)
