...
3. Next, we group probe\:detector aggregate defcons by :doc:`Tier <../probes/probes._tier>` into two lists, one for Tier 1, one for Tier 2. Tiers 3+ are not currently included.
